      ...
      <div className="max-w-2xl mx-auto px-6 py-16">
        ...
        <div className="mb-16 text-center">
          <div className="mb-4">
            ...
            <div className="text-lg font-sans font-semibold">Abdul Kudoos</div>
          </div>
          <h1 className="text-sm font-sans mb-2 text-gray-400">
            Product Designer. Design Growth and Strategy. Based worldwide. Available Globally.
          </h1>
        </div>
        ...
        <div className="mb-16">
          <div className="grid gap-4 text-sm font-sans">
            <div className="group relative flex justify-between items-center py-2 border-b border-gray-800 select-none cursor-default">
              <div>
                <div className="flex items-center gap-2 mb-1">
                  <div className="text-white">Soared</div>
                </div>
                <div className="text-gray-400">Design Strategy Consultant</div>
              </div>
              <div className="text-gray-400">2025—Present</div>
              <div className="absolute bottom-0 left-0 h-px bg-white w-0 group-hover:w-full transition-all duration-300 ease-out"></div>
            </div>

            <div className="group relative flex justify-between items-center py-2 border-b border-gray-800 select-none cursor-default">
              <div>
                <div className="flex items-center gap-2 mb-1">
                  <div className="text-white">Hone</div>
                </div>
                <div className="text-gray-400">Lead Product Designer</div>
              </div>
              <div className="text-gray-400">2023—2025</div>
              <div className="absolute bottom-0 left-0 h-px bg-white w-0 group-hover:w-full transition-all duration-300 ease-out"></div>
            </div>
            ...
            <div className="group relative flex justify-between items-center py-2 border-b border-gray-800 select-none cursor-default">
              <div>
                <div className="flex items-center gap-2 mb-1">
                  <div className="text-white">Mantle</div>
                </div>
                <div className="text-gray-400">Lead Product Designer</div>
              </div>
            ...
            <div className="group relative flex justify-between items-center py-2 border-b border-gray-800 select-none cursor-default">
              <div>
                <div className="flex items-center gap-2 mb-1">
                  <div className="text-white">United Nations</div>
                </div>
                <div className="text-gray-400">Brand Designer</div>
              </div>
              <div className="text-gray-400">2022</div>
              <div className="absolute bottom-0 left-0 h-px bg-white w-0 group-hover:w-full transition-all duration-300 ease-out"></div>
            </div>
            ...
            <div className="group relative flex justify-between items-center py-2 border-b border-gray-800 select-none cursor-default">
              <div>
                <div className="flex items-center gap-2 mb-1">
                  <div className="text-white">Innoloft</div>
                </div>
                <div className="text-gray-400">Lead Product Designer</div>
              </div>
              <div className="text-gray-400">2022—2022</div>
              <div className="absolute bottom-0 left-0 h-px bg-white w-0 group-hover:w-full transition-all duration-300 ease-out"></div>
            </div>
            ...
            <div className="group relative flex justify-between items-center py-2 border-b border-gray-800 select-none cursor-default">
              <div>
                <div className="flex items-center gap-2 mb-1">
                  <div className="text-white">Pixcap</div>
                </div>
                <div className="text-gray-400">Lead Product Designer</div>
              </div>
            ...
            <div className="group relative flex justify-between items-center py-2 border-b border-gray-800 select-none cursor-default">
              <div>
                <div className="flex items-center gap-2 mb-1">
                  <div className="text-white">Teen Controls</div>
                </div>
                <div className="text-gray-400">Founding Product Designer</div>
              </div>
              <div className="text-gray-400">2019—2020</div>
              <div className="absolute bottom-0 left-0 h-px bg-white w-0 group-hover:w-full transition-all duration-300 ease-out"></div>
            </div>
            ...
            <div className="group relative flex justify-between items-center py-2 border-b border-gray-800 select-none cursor-default">
              <div>
                <div className="flex items-center gap-2 mb-1">
                  <div className="text-white">Freelance</div>
                </div>
                <div className="text-gray-400">Designer</div>
              </div>
              <div className="text-gray-400">2017—2019</div>
              <div className="absolute bottom-0 left-0 h-px bg-white w-0 group-hover:w-full transition-all duration-300 ease-out"></div>
            </div>
          </div>
        </div>
        ...
        <div className="mb-16">
          ...
          <div className="grid gap-4 text-sm font-sans">
            <div className="group relative flex justify-between items-center py-2 border-b border-gray-800 select-none cursor-default">
              <div>
                <div className="text-white">IBM Certified Design Enterprise Co-Creator </div>
            ...
            <div className="group relative flex justify-between items-center py-2 border-b border-gray-800 select-none cursor-default">
              <div>
                <div className="text-white">IBM Certified Design Enterprise Practitioner</div>
                <div className="text-gray-400">
        ...
        <div className="mb-16">
          ...
          <div className="mb-12">
            <div className="mb-4">
              <Link href="/case-studies/hone" className="group">
                <h3 className="text-lg font-sans font-semibold mb-2 flex items-center gap-2">
                  ...
                  <ArrowUpRight className="w-5 h-5 text-white transform rotate-45 group-hover:rotate-90 transition-transform duration-300" />
                </h3>
              </Link>
            ...
            <Link href="/case-studies/hone" className="block group">
              <div className="grid grid-cols-10 gap-2 sm:gap-4 h-48 sm:h-56 md:h-64 transition-all duration-300 group-hover:scale-[1.01] group-hover:shadow-lg">
                <div className="col-span-3 bg-gray-900 rounded-lg overflow-hidden h-full">
                  <img
                ...
                <div className="col-span-7 bg-gray-900 rounded-lg overflow-hidden h-full relative">
                  <img
          ...
          <div className="mb-12">
            <div className="mb-4">
              ...
              <p className="text-sm font-sans text-gray-400 mb-6">Bringing Discord's intuitive experience to AR</p>
            </div>
            <div className="grid grid-cols-10 gap-2 sm:gap-4 h-48 sm:h-56 md:h-64">
              ...
              <div className="col-span-7 bg-gray-900 rounded-lg overflow-hidden h-full">
                <img
        ...
        {/* About Me Section */}
        <div className="mb-16">
          <h2 className="text-sm font-sans mb-6 font-semibold">About Me</h2>
          <div className="text-sm font-sans text-gray-300 leading-relaxed">
            <p className="mb-4">
              Born and raised in Lahore, Pakistan, I started designing and coding websites at 14. My early fascination
              with UX and human psychology led me to shift from web design to product design.
            </p>
            <p className="mb-4">
              Since then, I've worked with startups and enterprises to build products across web, TV, desktop, and
              mobile reaching millions of users. I've led design for global teams, created brand systems for the United
              Nations, and scaled product growth for companies worldwide.
            </p>
            <p>
              Most recently at Hone, as the sole designer, I helped drive a 16× increase in revenue through design led
        ...
        <div className="text-center">
          <div className="flex justify-center gap-8 text-sm font-sans">
            <a href="mailto:qudoos253@gmail.com" className="text-gray-400 hover:text-white transition-colors">
              Email
            </a>
            <a
