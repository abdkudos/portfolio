  ...
  return (
    <div className="min-h-screen bg-black text-white">
      <div className="max-w-2xl mx-auto px-6 py-16">
        ...
        <Link
          href="/"
          className="inline-flex items-center gap-2 text-sm font-sans text-gray-400 hover:text-white transition-colors mb-12"
        >
        ...
        <div className="mb-16">
          ...
          <p className="text-lg font-sans text-gray-300 mb-8">
            Built a cross platform grocery delivery app connecting millions of local vendors to buyers.

          </p>
          <div className="flex flex-wrap gap-4 text-sm font-sans">
            <span className="bg-gray-800 px-3 py-1 rounded-full">Product Strategy</span>
            <span className="bg-gray-800 px-3 py-1 rounded-full">Mobile Design</span>
            <span className="bg-gray-800 px-3 py-1 rounded-full">UX Research</span>
            <span className="bg-gray-800 px-3 py-1 rounded-full">iOS & Android</span>
          </div>
        </div>
        ...
        <div className="w-screen relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] mb-16">
          <div className="bg-gray-900 rounded-lg overflow-hidden mx-6">
            <img
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm font-sans text-gray-400">No tools to manage orders or reach customers online.</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <span className="w-2 h-2 bg-white rounded-full mt-2 flex-shrink-0"></span>
        ...
        <div className="mb-16">
          ...
          <p className="text-base font-sans text-gray-300 leading-relaxed mb-6">
