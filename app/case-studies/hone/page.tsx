      ...
      <div className="max-w-2xl mx-auto px-6 py-16">
        ...
        <div className="mb-16">
          ...
          <div className="flex flex-wrap gap-4 text-sm font-sans">
            ...
            <span className="bg-gray-800 px-3 py-1 rounded-full">Interaction Design</span>
            <span className="bg-gray-800 px-3 py-1 rounded-full">UX Design</span>
            <span className="bg-gray-800 px-3 py-1 rounded-full">Desktop</span>
          </div>
        </div>
        ...
        <div className="w-screen relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] mb-16">
          <div className="bg-gray-900 rounded-lg overflow-hidden aspect-video mx-6">
            <img
